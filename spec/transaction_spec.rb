...
describe Transaction do
  ...
  describe '#log_deposit' do
    it 'adds the deposit as a complete transaction' do
      ...
      expect(subject.transaction_details).to eq({date: '18/06/2018', credit: 5, debit:"      ", balance: 10})
    end
  end
  ...
  describe '#log_withdrawal' do
    it 'adds the deposit as a complete transaction' do
      ...
      expect(subject.transaction_details). to eq({date: '18/06/2018', credit:"      ", debit: 5, balance: 10})
    end
  end
end
